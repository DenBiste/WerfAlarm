...
const I18N = (() => {
  ...
  const D = {
    nl: {
      ...
      grpRideDetails: "Ritdetails", grpBlockadeDetails: "Blokkadedetails",
      rideDate: "Ritdatum", searchDist: "Zoekafstand (m)",
      startHour: "Startuur",
      startHourTitle: "Geplande vertrektijd. Vul ook einduur en snelheid in voor een automatische berekening.",
      endHour: "Einduur",
      endHourTitle: "Geplande aankomsttijd. Vul ook startuur en snelheid in voor een automatische berekening.",
      speedLbl: "Snelheid (km/u)",
      speedTitle: "Verwachte gemiddelde snelheid, met één decimaal. Vul ook startuur en einduur in voor een automatische berekening.",
      ...
      saveRouteTitle: "Bewaar deze route met je instellingen in je browser — geen account nodig",
      shareLink: "🔗 Deel link",
      shareLinkTitle: "Kopieer een deelbare link met deze route en je instellingen — wie hem opent ziet meteen de actuele check",
      savedRoutes: "💾 Bewaarde routes:",
      savedOk: "Route bewaard in je browser.",
      savedFail: "Bewaren mislukt — browseropslag vol of geblokkeerd.",
      linkCopied: "Deelbare link gekopieerd — plak hem in een bericht.",
    ...
    en: {
      ...
      grpRideDetails: "Ride details", grpBlockadeDetails: "Blockade details",
      rideDate: "Ride date", searchDist: "Search distance (m)",
      startHour: "Start hour",
      startHourTitle: "Planned departure time. Also fill in end hour and speed for an automatic calculation.",
      endHour: "End hour",
      endHourTitle: "Planned arrival time. Also fill in start hour and speed for an automatic calculation.",
      speedLbl: "Speed (km/h)",
      speedTitle: "Expected average speed, with one decimal. Also fill in start hour and end hour for an automatic calculation.",
      ...
      saveRouteTitle: "Save this route with your settings in your browser — no account needed",
      shareLink: "🔗 Share link",
      shareLinkTitle: "Copy a shareable link with this route and your settings — whoever opens it sees the current check right away",
      savedRoutes: "💾 Saved routes:",
      savedOk: "Route saved in your browser.",
      savedFail: "Saving failed — browser storage full or blocked.",
      linkCopied: "Shareable link copied — paste it into a message.",
